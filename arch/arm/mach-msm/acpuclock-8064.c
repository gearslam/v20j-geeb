...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[1]  = { {  288000, HFPLL, 0, 0x20 },  950000,  950000, 1 },
	[2]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	...
	[18] = { { 1242000, HFPLL, 1, 0x2E }, 1175000, 1175000, 5 },
	[19] = { { 1242000, HFPLL, 1, 0x2E }, 1175000, 1175000, 7 },
	[20] = { { 1296000, HFPLL, 1, 0x30 }, 1175000, 1175000, 5 },
	[21] = { { 1350000, HFPLL, 1, 0x32 }, 1175000, 1175000, 5 },
	{ }
};
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(2),   975000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(7),  1000000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(7),  1000000 },
...
#ifdef CONFIG_OC_TURBO
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(17), 1300000 },
	{ 1, {  1944000, HFPLL, 1, 0x46 }, L2(17), 1325000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   192000, PLL_8, 0, 0x00 }, L2(0),   825000 },
	{ 1, {   288000, HFPLL, 0, 0x20 }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(2),   925000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(7),   950000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(7),   950000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(7),   975000 },
	...
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(17), 1200000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(17), 1225000 },
#ifdef CONFIG_OC_TURBO
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(17), 1250000 },
	{ 1, {  1944000, HFPLL, 1, 0x46 }, L2(17), 1275000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {   192000, PLL_8, 0, 0x00 }, L2(0),   825000 },
	{ 1, {   288000, HFPLL, 0, 0x20 }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(2),   875000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(7),   900000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(7),   900000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(7),   925000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(7),   925000 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(7),   950000 },
...
#ifdef CONFIG_OC_TURBO
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(17), 1225000 },
	{ 1, {  1944000, HFPLL, 1, 0x46 }, L2(17), 1250000 },
#endif
	{ 0, { 0 } }
};
...
static struct pvs_table pvs_tables[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	...
	[0][PVS_FASTER]  = {tbl_fast, sizeof(tbl_fast), 26000 },
